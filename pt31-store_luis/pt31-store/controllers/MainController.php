...
class MainController {
    ...
    public function doProductStock(){
        ...
        if($exists){
            $result=$this->model->seeStockProduct($search);
            $this->view->show("warehousesproduct/warehouseproductmanage.php",["list"=>$result,'message'=>'List of products']);
        }else {
            //pass information message to view and show.
    ...
    public function doWarehouseStock(){
        ...
        $exists=!is_null($search);
        if($exists){
            $result=$this->model->seeStockWarehouse($search);
            $this->view->show("warehousesproduct/warehouseproductmanage.php",["list"=>$result,'message'=>'List of warehouses']);
        }else {
            //pass information message to view and show.
            $this->view->show("warehousesproduct/warehouseproductmanage.php", ['message' => "No data found"]);   
        }
